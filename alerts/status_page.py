...
def initialize_status_page():
    """
    Creates a new status page, removing any existing one.
    
    Returns:
        bool: True if status page was initialized successfully, False otherwise
    """
    try:
        status_page_path = os.environ.get('IPTIC_STATUS_PAGE', './status.html')
        
        # Generate empty HTML status page
        html = f"""<!DOCTYPE html>
<html>
<head>
...
"""
        ...
        logger.info(f"Status page initialized at {status_page_path}")
        return True
        
    except Exception as e:
        logger.error(f"Failed to initialize status page: {e}")
        return False
